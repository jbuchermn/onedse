...
namespace core::map{
    ...
    class MapDensityOperator: public core::map::Map<core::state::DensityOperator>{
        ...
        public:
            ...
            Term(std::shared_ptr<const core::discretization::Basis> basis_);
        ...
        MapDensityOperator(std::shared_ptr<const core::discretization::Basis> basis, std::vector<Term> terms_);
    ...
    public:
        ...
        MapDensityOperator(std::shared_ptr<const core::discretization::Basis> basis);
