...
namespace wigner_web::system{
    ...
    public:
        ...
        std::shared_ptr<wigner_web::propagation::DiagonalPropagator> create_wavefunction_propagator(std::string name, std::shared_ptr<wigner_web::map::OperatorWaveFunction> map) const;
